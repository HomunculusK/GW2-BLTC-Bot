...
#This takes all your sell offer so it can exclude them from buying
...
inputAPI.send_keys('Your API')#PUT YOUR API KEY HERE
time.sleep(0.15)
driver.find_element(By.ID, "sign-in-submit").click()
time.sleep(17.5)
driver.find_element(By.LINK_TEXT, "Sell Offers").click()
time.sleep(1.5)
...
b = open(r'\data\SellOffers.txt','w+')
